...
export default function RootLayout({ children }) {
  ...
  return (
          ...
          <Layout style={{ minHeight: "100vh" }}>
            ...
            <Layout>
              ...
              >
                ...
                <span className='text-xl font-semibold text-white '>The Ark</span>
                </div>
                 <Menu
                theme="dark"
                mode="horizontal"
              ...
              >
                <Menu.Item key="1" icon={<RiHome2Fill />}>
                  <Link href="/dashboard">
                    Dashboard
                  </Link>
                </Menu.Item>
                ...
                <Menu.Item key="3" icon={<IoRocketSharp />}>
                  <Link href="/dashboard/holdings">
                      <span clanssName='flex space-x-4'>
                        <span>New Listings</span>
                        <span className='bg-red-600 p-1 rounded-md text-white text-xs ml-2'>Beta</span>
                      </span>
                  </Link>
                </Menu.Item>
              </Menu>
    ...
    />
    <Drawer title="Basic Drawer" open={filterDrawer}>
        <p>Some contents...</p>
        <p>Some contents...</p>
        <p>Some contents...</p>
      </Drawer>
              ...
              >
                <div className='w-[95%]'>
                  ...
                  <div className='flex justify-between p-3 items-center'>
                    <span>
                      Copyright ©2023 - {new Date().getFullYear()} The Ark Inc. All rights reserved
                    </span>
                    <div className='flex space-x-5'>
                      <div className='p-2 bg-gray-200 rounded-full'><FaTwitter  size={24} className='text-[#80808080]'/></div>
                      <div className='p-2 bg-gray-200 rounded-full'><FaGithub  size={24} className='text-[#80808080]'/></div>
                      <div className='p-2 bg-gray-200 rounded-full'><FaYoutube size={24} className='text-[#80808080]'/></div>
                    </div>
                  </div>
                </div>
              </Footer>
