  ...
  return (
    <section className='p-[2rem] h-[500px] flex items-center justify-center'>
      <div className='w-full h-full subbg rounded-[40px] flex items-center justify-center flex-col relative'>
        ...
        <h2 className='md:text-4xl text-xl relative'>Subscribe To Our Newsletter</h2>
        <p className='my-[2rem] md:w-[55%] text-center relative'>Stay updated on the latest trends and news in tech and blockchain. No spammy messages, only top notch contents and notifications</p>
        <form className='md:w-[50%] w-4/5 md:mx-auto text-center relative'>
