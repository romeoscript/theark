      ...
      <section>
        <div className='flex items-center justify-between px-[3rem] '>
          <div className='relative ' >
            <img src={logo.src} className='block' alt="" />
            <p className='text-white font-bold text-3xl absolute bottom-4 left-[30%]'>The Ark</p>
          </div>
        ...
        <div className='flex items-center justify-center text-white'>
          <p className='px-[1rem]'>Customer Support</p>
          <p className='px-[2rem] border-l border-r border-gray-300'>Privacy  Policy</p>
          <p className='px-[1rem]'>Terms & Condition</p>
        </div>
        <hr className='my-[1rem] w-4/5 m-auto' />
        <figure className='text-white flex items-center gap-4 justify-between py-[1rem] px-[4rem]'>
          <p>Copyright © 2023 - 2024 The Ark Inc. All rights reserved</p>
